...
public class JEEQSorterApp extends JFrame implements ListSelectionListener {
    
    static final Logger log = Logger.getLogger( JEEQSorterApp.class ) ;
    ...
    public static void main( String[] args ) {
        File baseDestDir = new File( "/home/sandeep/projects/source/JEECoachQuestionImages/" ) ;
        File baseSrcDir = new File( "/home/sandeep/temp/question-scrapes" ) ;
        new JEEQSorterApp( baseDestDir, baseSrcDir ) ;
    }

    public JEEQSorterApp( File baseDestDir, File baseSrcDir ) {
